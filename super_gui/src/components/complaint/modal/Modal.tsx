...
export const Modal = ({ isOpen, closeModal, handleOutsideClickOrTap }: ModalProps) => {
  ...
  return (
    <>
      {isOpen && (
        <div className="modal z-10 fixed inset-0 bg-charcoal/75 backdrop-blur-sm  flex justify-center items-center" aria-labelledby="modal-title" role="dialog" aria-modal="true">
          <div className="modal-content bg-beige p-6 w-full max-w-sm shadow-lg rounded-lg">
            ...
            <div>
              ...
              <div className="description-input pb-6">
                <input type="text" placeholder="brief description..." className="bg-grey-100 border-grey-400 rounded-md w-full h-30 border-1"/>
              </div>
